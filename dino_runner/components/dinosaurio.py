...
from dino_runner.utils.constants import DEFAULT_TYPE, DUCKING_SHIELD, FONT_STYLE, JUMPING, JUMPING_SHIELD, RUNNING, DUCKING, RUNNING_SHIELD, SCREEN_HEIGHT, SCREEN_WIDTH, SHIELD_TYPE
