...
from dino_runner.utils.constants import BG, DINO_START, FONT_STYLE, ICON, SCREEN_HEIGHT, SCREEN_WIDTH, SHIELD_TYPE, TITLE, FPS, HAMMER_TYPE
...
class Game:
    def __init__(self):
        ...
        self.hammer = Hammer().set_pos(self.player.rect)
    ...
    def update(self):
        ...
        self.obstacle_manager.update(self.game_speed, self.player, self.on_death, self.on_reset_power)
