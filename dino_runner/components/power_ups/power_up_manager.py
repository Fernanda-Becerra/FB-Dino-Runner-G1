...
class PowerUpManager:
    ...
    def update(self, game_speed, score,player):
        ...
        if not self.power_ups and score == self.when_appears_hammer:
            self.when_appears += random.randint(600, 800)
    ...
    def reset(self):
        ...
        self.when_appears_hammer = random.randint(300, 400)